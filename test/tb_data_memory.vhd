    ...
    begin
        ...
        test_cases_loop : while test_suite loop
            ...
            if run("test_outputs_are_zero_if_reset_is_enabled") then
                ...
                write_enable      <= '0';
                write_back_enable <= '0';
                address_bytes     <= std_logic_vector(to_signed(100, 32));
                ...
                write_data           <= (others => '0');
                address_bytes        <= std_logic_vector(to_signed(20000, 32));
                wait for CLK_PERIOD * 2;
                reset                <= '0';
                wait for CLK_PERIOD * 2;
                ...
                state_machine_enable <= '1';
                write_data           <= (others => '0');
                address_bytes        <= std_logic_vector(to_signed(4000, 32));
                wait for CLK_PERIOD * 2;
                reset                <= '0';
                wait for CLK_PERIOD * 2;
                check_equal(mem_access_err, '0');
                ...
                state_machine_enable <= '1';
                write_data           <= (others => '0');
                data_mem(12)         <= force std_logic_vector(to_signed(100, 32));
                address_bytes        <= std_logic_vector(to_signed(48, 32));
                wait for CLK_PERIOD * 2;
                reset                <= '0';
                wait for CLK_PERIOD * 2;
                check_equal(output, std_logic_vector(to_signed(100, 32)));
                check_equal(mem_access_err, '0');
                check_equal(temp_mem, std_logic_vector(to_signed(100, 32)));
                check_sig            <= 1;
                info("===== TEST CASE FINISHED =====");
                ...
                write_back_enable <= '1';
                store_type        <= "010";
                write_data        <= std_logic_vector(to_signed(500160, 32));
                address_bytes     <= std_logic_vector(to_signed(24, 32));
                wait for CLK_PERIOD * 2;
                write_enable      <= '0';
                wait for CLK_PERIOD * 2;
                check_equal(data_mem(6), std_logic_vector(to_signed(500160, 32)));
                check_equal(mem_access_err, '0');
                check_sig         <= 1;
                info("===== TEST CASE FINISHED =====");
                ...
                write_back_enable <= '1';
                store_type        <= "010";
                write_data        <= std_logic_vector(to_signed(964160, 32));
                address_bytes     <= std_logic_vector(to_signed(24, 32));
                wait for CLK_PERIOD * 2;
                store_type        <= "000";
                write_data        <= std_logic_vector(to_signed(500160, 32));
                ...
                write_enable      <= '0';
                wait for CLK_PERIOD * 2;
                check_equal(data_mem(6), std_logic_vector(to_signed(964288, 32)));
                check_equal(mem_access_err, '0');
                check_sig         <= 1;
                ...
                write_enable      <= '0';
                wait for CLK_PERIOD * 2;
                check_equal(data_mem(6), std_logic_vector(to_signed(958912, 32)));
                check_equal(mem_access_err, '0');
                check_sig         <= 1;
                info("===== TEST CASE FINISHED =====");
            end if;
