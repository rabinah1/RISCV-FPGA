    ...
    begin
        ...
        test_cases_loop : while test_suite loop
            ...
            if run("test_outputs_are_zero_if_reset_is_enabled") then
                ...
                reset      <= '1';
                enable     <= '1';
                rs1        <= std_logic_vector(to_signed(12, 5));
                rs2        <= std_logic_vector(to_signed(6, 5));
                rd         <= (others => '0');
                write      <= '1';
                write_data <= (others => '0');
                wait for CLK_PERIOD * 2;
                check_equal(reg_out_1, std_logic_vector(to_signed(0, 32)));
                check_equal(reg_out_2, std_logic_vector(to_signed(0, 32)));
                check_equal(reg_out_uart, std_logic_vector(to_signed(0, 32)));
                check_equal(address_out_uart, std_logic_vector(to_signed(0, 6)));
                ...
                reset      <= '1';
                enable     <= '0';
                rs1        <= std_logic_vector(to_signed(15, 5));
                rs2        <= std_logic_vector(to_signed(20, 5));
                rd         <= (others => '0');
                write      <= '0';
                write_data <= (others => '0');
                wait for CLK_PERIOD * 2;
                reset      <= '0';
                regs(15)   <= force std_logic_vector(to_signed(100, 32));
                regs(20)   <= force std_logic_vector(to_signed(200, 32));
                wait for CLK_PERIOD * 2;
                check_equal(reg_out_1, std_logic_vector(to_signed(100, 32)));
                check_equal(reg_out_2, std_logic_vector(to_signed(200, 32)));
                check_sig  <= 1;
                info("===== TEST CASE FINISHED =====");
                ...
                rs1        <= (others => '0');
                rs2        <= (others => '0');
                rd         <= std_logic_vector(to_signed(6, 5));
                write      <= '1';
                write_data <= std_logic_vector(to_signed(123, 32));
                wait for CLK_PERIOD * 2;
                reset      <= '0';
                wait for CLK_PERIOD * 2;
                write      <= '0';
                wait for CLK_PERIOD * 2;
                check_equal(regs(6), std_logic_vector(to_signed(123, 32)));
                check_sig  <= 1;
                info("===== TEST CASE FINISHED =====");
                ...
                rs1        <= (others => '0');
                rs2        <= (others => '0');
                rd         <= std_logic_vector(to_signed(0, 5));
                write      <= '1';
                write_data <= std_logic_vector(to_signed(123, 32));
                wait for CLK_PERIOD * 2;
                reset      <= '0';
                ...
                write      <= '0';
                wait for CLK_PERIOD * 2;
                check_equal(regs(0), std_logic_vector(to_signed(0, 32)));
                check_sig  <= 1;
                info("===== TEST CASE FINISHED =====");
                ...
                wait for CLK_PERIOD * 2;
                reset         <= '0';
                regs(0)       <= force std_logic_vector(to_signed(123, 32));
                wait for CLK_PERIOD * 2;
                check_equal(reg_dump_start, '1');
                check_equal(reg_out_uart, std_logic_vector(to_signed(123, 32)));
                check_equal(address_out_uart, std_logic_vector(to_signed(0, 6)));
                check_sig     <= 1;
                info("===== TEST CASE FINISHED =====");
            end if;
